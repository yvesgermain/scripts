...
$barcode = Get-VBRTapeMedium | Where-Object {$_.IsExpired -and $_.barcode -like "*l8"} | Sort-Object "Barcode"
$slot = Get-VBRTapeMedium |Where-Object { $_.IsExpired -eq $False -and $_.IsFree -eq $False -and ($_.Location -eq "slot" -and ($_.free -lt "10000000000") -and $_.barcode -like "*l8") } | Select-Object -Property @{N="Barcode";E={$_.Barcode}}, @{N="Protected Until";E={$_.ExpirationDate}}, @{N="Location";E={$_.Location}}, @{N="SlotNo";E={$_.Location.SlotAddress +1}},@{N="Free Space";E={$_.free}}| sort-object -Property "Protected Until"
